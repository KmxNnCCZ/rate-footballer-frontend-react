...
export const TermOfUse = () => {
  return (
    ...
    >
      ...
      <Text mb="30px" >
        この利用規約（以下，「本規約」といいます。）は，Rate-Footballer（以下，「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </Text>

    <VStack spacing='50px'>
      <Box>
        <Article>第1条（適用）</Article>
        <ArticleBox>
            <ParentUnorderedList spacing={2}>
              <ListItem>
      ...
      <Box>
        <Article>第3条（ユーザーIDおよびパスワードの管理）</Article>
       <ArticleBox>
          <ParentUnorderedList spacing={2}>
            <ListItem>
      ...
      <Box>
        <Article>第5条（本サービスの提供の停止等）</Article>
       <ArticleBox>
          <ParentUnorderedList spacing={2}>
            <ListItem>
      ...
      <Box>
        <Article>第7条（利用制限および登録抹消）</Article>
       <ArticleBox>
          <ParentUnorderedList spacing={2}>
            <ListItem>
      ...
      <Box>
        <Article>第9条（保証の否認および免責事項）</Article>
       <ArticleBox>
          <ParentUnorderedList spacing={2}>
            <ListItem>
      ...
      <Box>
        <Article>第10条（サービス内容の変更等）</Article>
       <ArticleBox>
      ...
      <Box>
        <Article>第14条（権利義務の譲渡の禁止）</Article>
       <ArticleBox>
